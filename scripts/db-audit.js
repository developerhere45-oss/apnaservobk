...
const expectedIndexes = [
  ...
  { model: "Payment", keys: { razorpayOrderIdHash: 1 }, unique: true, reason: "idempotent gateway order" },
  { model: "Payment", keys: { razorpayPaymentIdHash: 1 }, unique: true, reason: "idempotent gateway payment" },
  { model: "Invoice", keys: { bookingId: 1 }, unique: true, reason: "one invoice per booking" },
  { model: "Invoice", keys: { paymentId: 1 }, unique: true, reason: "one invoice per payment" },
  { model: "Invoice", keys: { invoiceNumber: 1 }, unique: true, reason: "unique printable invoice number" },
...
const relationChecks = [
  ...
  ["Invoice.bookingId", "Invoice", "bookingId", "Booking"],
  ["Invoice.paymentId", "Invoice", "paymentId", "Payment"],
  ["Invoice.userId", "Invoice", "userId", "User"],
  ["Invoice.partnerId", "Invoice", "partnerId", "Partner"],
